...
var Webcam = {
	...
	getSWFHTML: function() {
		...
		if (!this.detectFlash()) {
			...
			return '<h3 style="color:red">ERROR: No Adobe Flash Player detected. Please go to <a href="https://get.adobe.com/flashplayer/">https://get.adobe.com/flashplayer/</a> to install Adobe Flash Player to continue using Tabluu. Alternatively, please open this link using another browser like Chrome, Firefox or Opera.</h3>';
		}
