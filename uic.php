						...
						<div class="right-content bgwhite fr">
							...
							<section class="uic-section-box hide">
								<form id="frmUIC3" action="#" method="post" enctype="multipart/form-data" >
									...
									<input type="text" data-clear-btn="true" name="txtbox18" id="txtbox18" value="If you are shy, at least take a photo of anything interesting around you! This won't work unless you take a photo!" placeholder="If you are shy, at least take a photo of anything interesting around you! This won't work unless you take a photo!">
