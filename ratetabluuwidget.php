...
<head>
	...
	<script type="text/javascript">var tabluurated = <?=$_REQUEST['rated']?></script>
...
<body>
	...
	<div id="fb-root"></div>
	<div class="rate" id="ratetabluuwidget" data-dom-cache="false" data-role="page" data-prefetch="false">
